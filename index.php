...
$binom_cloaker->os_white='Android,iOS,OS X, Windows'; //Список разрешённых ОС
$binom_cloaker->country_white='RO,RU'; //Строка двухбуквенных обозначений стран через запятую, допущенных к blackpage
...
{
  $whitePage=header('Location:http://rambler.ru');
  echo $whitePage;
}
?>